...
def main():
    ...
    # train LBAFL
    for idx in range(DRL_ROUND):
        print('#------------------------------------------------------------------------------')
        print(f'LBAFL Training Round {idx}')
        print('#------------------------------------------------------------------------------')
        print()
        ...
        while round_num != ROUNDS:      
            ...
            #------------------------------------------------------------------------------
            if MDP is not None:                
                # add done = False to MDP
                done = False
                MDP.append(done)
                
                # remember MDP and learn
                LBAFL.store_transition(MDP[0], MDP[1], MDP[2], MDP[3], MDP[4])
                LBAFL.learn()        
        ...
        #------------------------------------------------------------------------------
        # Save models at every end of DRL round
        #------------------------------------------------------------------------------
        # save LBAFL
        LBAFL.save_models()            
    ...
    #------------------------------------------------------------------------------        
    # save LBAFL at the end of DRL training
    #------------------------------------------------------------------------------
    LBAFL.save_models()          
